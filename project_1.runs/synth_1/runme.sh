...
HD_PWD='C:/Users/urkmez/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ucak_tazminat.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ucak_tazminat.tcl
